...
func _process(_delta: float) -> void:
	for i in Main.currentboard:
		if Main.board[i] == 'bpawn' and Main.currentboard[i] != 'bpawn':
		...
		if Main.board[i] == 'brook' and Main.currentboard[i] != 'brook':
		...
		if Main.board[i] == 'bking' and Main.currentboard[i] != 'bking':
		...
		if Main.board[i] == 'bbishop' and Main.currentboard[i] != 'bbishop':
		...
		if Main.board[i] == 'bknight' and Main.currentboard[i] != 'bknight':
		...
		if Main.board[i] == 'bqueen' and Main.currentboard[i] != 'bqueen':
